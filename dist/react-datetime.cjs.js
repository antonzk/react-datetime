module.exports = function (e) {
    ...
    function l(e) {
        ...
        return u.a.createElement("tr", null, u.a.createElement("th", {
            ...
            colSpan: i,
            onClick: n
        }, a), o), u.a.createElement("th", {className: "rdtNext", onClick: r}, u.a.createElement("span", null, "›")))
    }
        ...
        return t = i, (n = [{
            ...
            key: "renderDay", value: function (e, t, n) {
                var r = this.props.selectedDate,
                    o = {key: e.format("M_D"), "data-value": e.date(), "data-month": e.month(), "data-year": e.year()},
                    i = "rdtDay";
    ...
    var W = function (e) {
        ...
        return t = i, (n = [{
            ...
            key: "renderYears", value: function () {
                for (var e = this.getViewYear(), t = [[], [], []], n = e - 1; n < e + 11; n++) z(t, n - e).push(this.renderYear(n));
    ...
    var le, pe, fe = (void 0 === le && (le = 0), function () {
        return ++le
    }), de = {}, he = {}, me = ["touchstart", "touchmove"];

    function ye(e, t) {
        var n = null;
        return -1 !== me.indexOf(t) && pe && (n = {passive: !e.props.preventDefault}), n
    }
        ...
        return r = n = function (n) {
            ...
            function a(e) {
                ...
                return (r = n.call(this, e) || this).__outsideClickHandler = function (e) {
                    ...
                    if ("undefined" != typeof document && !he[r._uid]) {
    ...
    var Ne = "years", xe = "months", Fe = "days", Ie = "time", Re = o.a, Me = function () {
        ...
        return ke(n, [{
            ...
            key: "getInitialState", value: function () {
                var e = this.props, t = this.getFormat("datetime"), n = this.parseDate(e.value || e.initialValue, t);
                return this.checkTZ(), {
                    open: !e.input,
